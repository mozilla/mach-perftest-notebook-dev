...
def artifact_downloader_parser():
    ...
    parser.add_argument('--platform', type=str, default='test-linux64-ccov',
                        help='Platform to obtain data from.')
    parser.add_argument('--download-failures', action='store_true', default=False,
                        help='Platform to obtain data from.')
    parser.add_argument('--ingest-continue', action='store_true', default=False,
...
def artifact_downloader(
    ...
    for task in tasks:
        ...
        if all_tasks or download_this_task:
            ...
            def get_artifacts(task_id, downloads_dir, data_dir,
                             unzip_artifact, test_counter, test_name, artifact_to_get,
            ...
            t = threading.Thread(
                ...
                args=(
                    task_id, downloads_dir, data_dir,
                    unzip_artifact, task_counters[test_name], test_name, artifact_to_get,
                    download_failures, taskid_to_file_map
                )
            )
            t.daemon = True
...
def main():
    ...
    task_dir, head_rev = artifact_downloader(
        ...
        platform=platform, download_failures=download_failures,
